...
export { IOT_SDK_METRICS_FEATURE_VERSION, MetricsFeatureId, retry_jitter_metrics_value, session_behavior_metrics_value, outbound_topic_alias_metrics_value, inbound_topic_alias_metrics_value, protocol_version_metrics_value, merge_feature_lists, create_metrics, _setSdkMetricsFactory, _buildSdkMetrics, } from "../common/aws_iot_metrics";
 ...
 * @internal
 */
export declare function get_encoded_feature_list_mqtt5(config: Mqtt5ClientConfig): string;
/**
 * Generates the encoded feature list string for metrics from a browser
 ...
 * @internal
 */
export declare function get_encoded_feature_list_mqtt3(_config: MqttConnectionConfig): string;
/**
 ...
 * @internal
 */
export declare function create_metrics_mqtt5(config: Mqtt5ClientConfig): mqtt_shared.AWSIoTMetrics;
/**
 ...
 * @internal
 */
export declare function create_metrics_mqtt3(config: MqttConnectionConfig): mqtt_shared.AWSIoTMetrics;
