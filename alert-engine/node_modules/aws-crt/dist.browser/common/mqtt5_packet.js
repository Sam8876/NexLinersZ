...
(function (ConnectReasonCode) {
     ...
     */
    ConnectReasonCode[ConnectReasonCode["UnacceptableProtocolVersion311"] = 1] = "UnacceptableProtocolVersion311";
    /**
     * (MQTT 311 Only) The connection was rejected because the server does not allow the requested client id.
     */
    ConnectReasonCode[ConnectReasonCode["ClientIdRejected311"] = 2] = "ClientIdRejected311";
    /**
     * (MQTT 311 Only) The connection was rejected because the server is not accepting MQTT connections.
     */
    ConnectReasonCode[ConnectReasonCode["ServerUnavailable311"] = 3] = "ServerUnavailable311";
    /**
     ...
     */
    ConnectReasonCode[ConnectReasonCode["InvalidUsernameOrPassword311"] = 4] = "InvalidUsernameOrPassword311";
    /**
     * (MQTT 311 Only) The connection was rejected because the client is not authorized to connect.
     */
    ConnectReasonCode[ConnectReasonCode["NotAuthorized311"] = 5] = "NotAuthorized311";
    /**
...
(function (SubackReasonCode) {
     ...
     */
    SubackReasonCode[SubackReasonCode["Failure311"] = 128] = "Failure311";
    /**
     * Returned when the connection was closed but the sender does not want to specify a reason or none
     * of the other reason codes apply.
     */
