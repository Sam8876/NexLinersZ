...
var BufferedEvent = /** @class */ (function () {
    ...
    BufferedEvent.newWithEmissionCallback = function (key, callback, args) {
        var bufferedEvent = new BufferedEvent(key, args);
...
var BufferedEventEmitter = /** @class */ (function (_super) {
    ...
    BufferedEventEmitter.prototype.emitWithCallback = function (event, emissionCallback) {
        var args = [];
        ...
        var result = _super.prototype.emit.apply(this, __spreadArray([event], __read(args), false));
        emissionCallback();
        return result;
    };
