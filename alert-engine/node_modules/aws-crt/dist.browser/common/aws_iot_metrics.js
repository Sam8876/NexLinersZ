...
exports._buildSdkMetrics = exports._setSdkMetricsFactory = exports.create_metrics = exports.merge_feature_lists = exports.protocol_version_metrics_value = exports.inbound_topic_alias_metrics_value = exports.outbound_topic_alias_metrics_value = exports.session_behavior_metrics_value = exports.retry_jitter_metrics_value = exports.MetricsFeatureId = exports.IOT_SDK_METRICS_FEATURE_VERSION = void 0;
/**
...
var mqtt_shared = __importStar(require("./mqtt_shared"));
 ...
 * @internal
 */
exports.IOT_SDK_METRICS_FEATURE_VERSION = 1;
/**
 ...
 * @internal
 */
var MetricsFeatureId;
(function (MetricsFeatureId) {
    MetricsFeatureId["RETRY_JITTER_MODE"] = "A";
    MetricsFeatureId["SESSION_BEHAVIOR"] = "B";
    MetricsFeatureId["OFFLINE_QUEUE_BEHAVIOR"] = "C";
    MetricsFeatureId["OUTBOUND_TOPIC_ALIAS_BEHAVIOR"] = "D";
    MetricsFeatureId["INBOUND_TOPIC_ALIAS_BEHAVIOR"] = "E";
    MetricsFeatureId["PROTOCOL_VERSION"] = "F";
    MetricsFeatureId["SOCKET_IMPLEMENTATION"] = "G";
    MetricsFeatureId["HTTP_PROXY_TYPE"] = "H";
    MetricsFeatureId["CERTIFICATE_SOURCE"] = "I";
    MetricsFeatureId["TLS_CIPHER_PREFERENCE"] = "J";
    MetricsFeatureId["MINIMUM_TLS_VERSION"] = "K";
})(MetricsFeatureId = exports.MetricsFeatureId || (exports.MetricsFeatureId = {}));
 ...
 * @internal
 */
function retry_jitter_metrics_value(mode) {
    switch (mode) {
...
exports.retry_jitter_metrics_value = retry_jitter_metrics_value;
/**
 ...
 * @internal
 */
function session_behavior_metrics_value(behavior) {
    switch (behavior) {
...
exports.session_behavior_metrics_value = session_behavior_metrics_value;
/**
 ...
 * @internal
 */
function outbound_topic_alias_metrics_value(behavior) {
    switch (behavior) {
...
exports.outbound_topic_alias_metrics_value = outbound_topic_alias_metrics_value;
/**
 ...
 * @internal
 */
function inbound_topic_alias_metrics_value(behavior) {
    switch (behavior) {
...
exports.inbound_topic_alias_metrics_value = inbound_topic_alias_metrics_value;
/**
 ...
 * @internal
 */
function protocol_version_metrics_value(protocol) {
    return protocol === mqtt_shared.ProtocolMode.Mqtt5 ? "5" : "3";
}
exports.protocol_version_metrics_value = protocol_version_metrics_value;
// ---- Merge + Create ----
/**
 ...
 * @internal
 */
function merge_feature_lists(crtFeatures, userFeatures) {
    var e_1, _a, e_2, _b;
    var merged = new Map();
    try {
        for (var _c = __values(crtFeatures.split(",")), _d = _c.next(); !_d.done; _d = _c.next()) {
            var pair = _d.value;
            var idx = pair.indexOf("/");
            if (idx > 0)
                merged.set(pair.substring(0, idx), pair.substring(idx + 1));
        }
    }
    ...
    if (userFeatures) {
        try {
            for (var _e = __values(userFeatures.split(",")), _f = _e.next(); !_f.done; _f = _e.next()) {
                var pair = _f.value;
                var idx = pair.indexOf("/");
                if (idx > 0)
                    merged.set(pair.substring(0, idx), pair.substring(idx + 1));
    ...
    return Array.from(merged.entries()).map(function (_a) {
        var _b = __read(_a, 2), k = _b[0], v = _b[1];
        return "".concat(k, "/").concat(v);
    }).join(",");
}
exports.merge_feature_lists = merge_feature_lists;
/**
 ...
 * @internal
 */
function create_metrics(userMetrics, crtFeatureList) {
    var e_3, _a;
    var _b;
    var finalMetrics = new mqtt_shared.AWSIoTMetrics();
    finalMetrics.libraryName = (_b = userMetrics === null || userMetrics === void 0 ? void 0 : userMetrics.libraryName) !== null && _b !== void 0 ? _b : mqtt_shared.SDK_NAME;
    var metadata = new Map();
    metadata.set("CRTVersion", (0, platform_1.crt_version)());
    var userMetricsVersion;
    var userFeature = "";
    if (userMetrics === null || userMetrics === void 0 ? void 0 : userMetrics.metadata) {
        try {
            for (var _c = __values(userMetrics.metadata), _d = _c.next(); !_d.done; _d = _c.next()) {
    ...
    if (userMetricsVersion !== undefined &&
        Number(userMetricsVersion) === exports.IOT_SDK_METRICS_FEATURE_VERSION) {
    ...
    metadata.set("IoTSDKMetricsVersion", String(exports.IOT_SDK_METRICS_FEATURE_VERSION));
    finalMetrics.metadata = Array.from(metadata.entries());
    return finalMetrics;
}
exports.create_metrics = create_metrics;
var _sdkMetricsFactory;
/**
 ...
 * @internal
 */
function _setSdkMetricsFactory(factory) {
    _sdkMetricsFactory = factory;
}
exports._setSdkMetricsFactory = _setSdkMetricsFactory;
/**
 ...
 * @internal
 */
function _buildSdkMetrics() {
    return _sdkMetricsFactory ? _sdkMetricsFactory() : undefined;
}
exports._buildSdkMetrics = _buildSdkMetrics;
//# sourceMappingURL=aws_iot_metrics.js.map