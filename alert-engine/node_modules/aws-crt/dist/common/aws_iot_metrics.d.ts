 ...
 * @internal
 */
export declare const IOT_SDK_METRICS_FEATURE_VERSION = 1;
/**
 ...
 * @internal
 */
export declare enum MetricsFeatureId {
    RETRY_JITTER_MODE = "A",
    SESSION_BEHAVIOR = "B",
 ...
 * @internal
 */
export declare function retry_jitter_metrics_value(mode?: mqtt5.RetryJitterType): string | undefined;
/**
 ...
 * @internal
 */
export declare function session_behavior_metrics_value(behavior?: mqtt5.ClientSessionBehavior): string | undefined;
/**
 ...
 * @internal
 */
export declare function outbound_topic_alias_metrics_value(behavior?: mqtt5.OutboundTopicAliasBehaviorType): string | undefined;
/**
 ...
 * @internal
 */
export declare function inbound_topic_alias_metrics_value(behavior?: mqtt5.InboundTopicAliasBehaviorType): string | undefined;
/**
 ...
 * @internal
 */
export declare function protocol_version_metrics_value(protocol: mqtt_shared.ProtocolMode): string;
/**
 ...
 * @internal
 */
export declare function merge_feature_lists(crtFeatures: string, userFeatures: string): string;
/**
 ...
 * @internal
 */
export declare function create_metrics(userMetrics: mqtt_shared.AWSIoTMetrics | undefined, crtFeatureList: string): mqtt_shared.AWSIoTMetrics;
/**
 ...
 * @internal
 */
export declare function _setSdkMetricsFactory(factory: SdkMetricsFactory): void;
/**
 ...
 * @internal
 */
export declare function _buildSdkMetrics(): mqtt_shared.AWSIoTMetrics | undefined;
