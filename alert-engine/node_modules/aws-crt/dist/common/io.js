...
exports.flogTrace = exports.flogDebug = exports.flogInfo = exports.flogWarn = exports.flogError = exports.flogFatal = exports.logTrace = exports.logDebug = exports.logInfo = exports.logWarn = exports.logError = exports.logFatal = exports.setLogLevel = exports.LogLevel = exports.SocketDomain = exports.SocketType = exports.TlsVersion = void 0;
/**
 *
 ...
 */
function log(level, subject, logLine) {
    if (logLevel < level) {
        return;
    }
...
function flog(level, subject, logLineGenerator) {
    if (logLevel < level) {
        return;
    }
    let currentTime = new Date().toISOString();
...
function flogFatal(subject, logLineGenerator) {
    flog(LogLevel.FATAL, subject, logLineGenerator);
}
exports.flogFatal = flogFatal;
function flogError(subject, logLineGenerator) {
    flog(LogLevel.ERROR, subject, logLineGenerator);
}
exports.flogError = flogError;
function flogWarn(subject, logLineGenerator) {
    flog(LogLevel.WARN, subject, logLineGenerator);
}
exports.flogWarn = flogWarn;
function flogInfo(subject, logLineGenerator) {
    flog(LogLevel.INFO, subject, logLineGenerator);
}
exports.flogInfo = flogInfo;
function flogDebug(subject, logLineGenerator) {
    flog(LogLevel.DEBUG, subject, logLineGenerator);
}
exports.flogDebug = flogDebug;
function flogTrace(subject, logLineGenerator) {
    flog(LogLevel.TRACE, subject, logLineGenerator);
}
exports.flogTrace = flogTrace;
