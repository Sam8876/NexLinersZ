...
export declare function flogFatal(subject: string, logLineGenerator: LogLineGenerator): void;
export declare function flogError(subject: string, logLineGenerator: LogLineGenerator): void;
export declare function flogWarn(subject: string, logLineGenerator: LogLineGenerator): void;
export declare function flogInfo(subject: string, logLineGenerator: LogLineGenerator): void;
export declare function flogDebug(subject: string, logLineGenerator: LogLineGenerator): void;
export declare function flogTrace(subject: string, logLineGenerator: LogLineGenerator): void;
