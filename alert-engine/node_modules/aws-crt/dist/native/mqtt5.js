...
exports.Mqtt5Client = exports.ClientExtendedValidationAndFlowControl = exports.HttpProxyOptions = void 0;
/**
...
const aws_iot_metrics_1 = require("./aws_iot_metrics");
...
class Mqtt5Client extends (0, native_resource_1.NativeResourceMixin)(event_1.BufferedEventEmitter) {
    ...
    static _s_on_message_received(client, message, pubackControlId) {
        let acknowledgementControl = undefined;
        if (pubackControlId !== undefined) {
            ...
            acknowledgementControl = new mqtt_shared.PublishAcknowledgementHandleWrapper(new mqtt_shared.PublishAcknowledgementHandle(() => {
                binding_1.default.mqtt5_client_invoke_publish_acknowledgement(client.native_handle(), controlId);
            }));
        }
