...
import { QoS, Payload, MqttRequest, MqttSubscribeRequest, OnMessageCallback, MqttConnectionConnected, MqttConnectionDisconnected, MqttConnectionResumed, OnConnectionSuccessResult, OnConnectionFailedResult, OnConnectionClosedResult } from "../common/mqtt";
 ...
 *
 * Extends {@link MqttConnectionConfigBase} with native-specific options.
 *
 * @category MQTT
 */
export interface MqttConnectionConfig extends crt.MqttConnectionConfigBase {
    /** Socket options */
