import { SimulatedVehicle, TelemetryPayload } from './types.js';
import { SIMULATED_ROUTES } from './routes.js';
...
export function advanceVehicle(vehicle: SimulatedVehicle, intervalSeconds = 1): TelemetryPayload {
  const route = SIMULATED_ROUTES[vehicle.routeId];
